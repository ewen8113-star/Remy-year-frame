...
CREATE TABLE IF NOT EXISTS activities (
    ...
    brand_ambassador VARCHAR(64),
    status VARCHAR(32) NOT NULL DEFAULT 'pending',
    remarks TEXT,
    cloud_album_url VARCHAR(1024),
    wine_details JSON,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS reimbursements (
    ...
    payment_type VARCHAR(32) NOT NULL DEFAULT 'personal_reimbursement' COMMENT '付款类型：个人报销/对公付款',
    cost_module VARCHAR(32) NOT NULL DEFAULT 'activity' COMMENT '成本模块：activity/warehouse/logistics/prop_repair/general',
    claim_status VARCHAR(24) NOT NULL DEFAULT 'draft' COMMENT '付款申请状态：draft/submitted/paid/rejected',
    city VARCHAR(50),
    amount DECIMAL(10,2),
    date DATE,
    related_project_code VARCHAR(100),
